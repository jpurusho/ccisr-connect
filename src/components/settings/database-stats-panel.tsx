...
const TABLE_DESCRIPTIONS: Record<string, string> = {
  ...
  event_locations: "Event locations (multi-location support)",
  event_breaks: "Scheduled break periods per event/location",
  event_virtual_config: "Zoom/virtual meeting configs",
  event_instance_locations: "Per-occurrence location overrides",
  bulletin_items: "Manual bulletin entries",
