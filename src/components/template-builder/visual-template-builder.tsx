...
import { Plus, Eye, ChevronDown, ChevronRight, Copy } from "lucide-react"
...
function FormattingHelp() {
  ...
  return (
    <div className="rounded-lg border border-blue-200 bg-blue-50/30 dark:border-blue-700/40 dark:bg-blue-950/20">
      <button
        type="button"
